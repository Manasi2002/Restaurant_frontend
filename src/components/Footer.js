...
function Footer()
{
    return(
            <div className="container-fluid text-center bg-dark" style= {{marginBottom:0}} id="footer">       
                ...
                <a href="/" className="font-weight-light text-light"style={{color: "white",fontSize: "110%"}}><i className="fas fa-phone" id="call-fafa" style={{color: "white",fontSize: "120%"}}></i> +91 1234567899  </a>
